...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    {
      url: `${siteConfig.url}/about/board-members`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: `${siteConfig.url}/our-results`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    ...
    {
      url: `${siteConfig.url}/ayurveda-colleges-2026-27`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${siteConfig.url}/top-neet-counseling-platform-in-mp`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.9,
    },
