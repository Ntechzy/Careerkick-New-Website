...
const datasets = [
  {
    ...
    columns: [
      { key: "serialNumber", label: "S. No", className: "w-[58px]" },
      { key: "collegeId", label: "College ID", className: "w-[96px]" },
      { key: "state", label: "State", className: "w-[112px]" },
      { key: "collegeName", label: "College Name", className: "w-[300px]" },
      { key: "district", label: "District", className: "w-[126px]" },
      { key: "managementType", label: "Type", className: "w-[128px]" },
      { key: "sanctionSeatsUgWithoutEws", label: "UG Without EWS", className: "w-[92px]" },
      { key: "sanctionSeatsUgWithEws", label: "UG With EWS", className: "w-[84px]" },
      { key: "totalSanctionSeatsUg", label: "Total UG", className: "w-[78px]" },
      { key: "sanctionSeatsPg", label: "PG Seats", className: "w-[78px]" },
      { key: "finalPermissionDetails", label: "Permission Details", className: "w-[528px]" },
    ],
    stats: [
  ...
  },
  {
    ...
    columns: [
      { key: "serialNumber", label: "S. No", className: "w-[70px]" },
      { key: "collegeName", label: "College Name", className: "w-[560px]" },
      { key: "district", label: "District", className: "w-[170px]" },
      { key: "sanctionSeatsUgWithoutEws", label: "UG Seats Without EWS", className: "w-[180px]" },
    ],
    stats: [
  ...
  },
  {
    ...
    columns: [
      { key: "serialNumber", label: "S. No", className: "w-[58px]" },
      { key: "collegeId", label: "College ID", className: "w-[96px]" },
      { key: "state", label: "State", className: "w-[120px]" },
      { key: "collegeName", label: "College Name", className: "w-[320px]" },
      { key: "district", label: "District", className: "w-[130px]" },
      { key: "managementType", label: "Type", className: "w-[116px]" },
      { key: "finalPermissionDetails", label: "Denial Details", className: "w-[580px]" },
    ],
    stats: [
